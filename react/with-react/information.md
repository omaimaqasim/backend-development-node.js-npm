...
> files that are in public folder is static files ,it mean that go to server and just after / write that file na it will show you about that file
...
> variable that we use in html and can change its value is called state
